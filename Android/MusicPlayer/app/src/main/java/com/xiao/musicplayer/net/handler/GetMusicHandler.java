...
public class GetMusicHandler extends HttpMessageHandler {
    private WeakReference<MusicActivity> musicActivity;

    public GetMusicHandler(MusicActivity activity) {
        super(activity);
        this.musicActivity = new WeakReference<>(activity);
    }
        ...
        try {
            ...
            switch (res) {
                ...
                case "true":
                    ...
                    musicActivity.get().initListView(musics);
                    break;
            }
