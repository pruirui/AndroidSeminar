...
public class HttpRe {
    ...
    //private static final String url = host + "/user/addUser";
/*
    public static void main(String[] args) {

        String fileName = "E:\\MyJavaProject\\idea\\URLDownloader\\1.png";
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("singer", "zhou");
        map.put("filename", "Admin");
...
*/
    public static void uploadFile(String fileName, Map<String, Object> map,String link) throws Exception {
        // 换行符
